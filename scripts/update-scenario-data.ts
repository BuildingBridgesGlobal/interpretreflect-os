      ...
      options: [
        {
          ...
          is_optimal: true,
          consequences: { maria_understood: true, role_maintained: true },
          score_impact: { linguistic_accuracy: 4, role_space_management: 5, equipartial_fidelity: 4, interaction_management: 4, cultural_competence: 3 },
          next_point: "dp2",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { maria_spoken_for: true, role_boundary_crossed: true },
          score_impact: { linguistic_accuracy: 3, role_space_management: 1, equipartial_fidelity: 2, interaction_management: 3, cultural_competence: 2 },
          next_point: "dp2_b",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { overstepped_role: true, maria_bypassed: true },
          score_impact: { linguistic_accuracy: 2, role_space_management: 0, equipartial_fidelity: 1, interaction_management: 2, cultural_competence: 1 },
          next_point: "dp2_c",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { advocated_prematurely: true, dr_interrupted: true },
          score_impact: { linguistic_accuracy: 2, role_space_management: 2, equipartial_fidelity: 3, interaction_management: 1, cultural_competence: 2 },
          next_point: "dp2_d",
      ...
      options: [
        {
          ...
          is_optimal: true,
          consequences: { accurate_interpretation: true, emotional_register_maintained: true },
          score_impact: { linguistic_accuracy: 5, role_space_management: 4, equipartial_fidelity: 5, interaction_management: 4, cultural_competence: 4 },
          next_point: "dp3",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { slightly_formal: true },
          score_impact: { linguistic_accuracy: 4, role_space_management: 4, equipartial_fidelity: 3, interaction_management: 4, cultural_competence: 3 },
          next_point: "dp3",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { third_person_used: true, maria_objectified: true },
          score_impact: { linguistic_accuracy: 2, role_space_management: 1, equipartial_fidelity: 1, interaction_management: 2, cultural_competence: 1 },
          next_point: "dp3_c",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { message_sanitized: true, maria_emotions_hidden: true },
          score_impact: { linguistic_accuracy: 1, role_space_management: 2, equipartial_fidelity: 0, interaction_management: 2, cultural_competence: 1 },
          next_point: "dp3_d",
      ...
      options: [
        {
          ...
          is_optimal: true,
          consequences: { maria_advocated_self: true, relationship_repairing: true },
          score_impact: { linguistic_accuracy: 5, role_space_management: 4, equipartial_fidelity: 5, interaction_management: 4, cultural_competence: 4 },
          next_point: "dp3",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { maria_frustration_hidden: true },
          score_impact: { linguistic_accuracy: 2, role_space_management: 3, equipartial_fidelity: 1, interaction_management: 3, cultural_competence: 2 },
          next_point: "dp3_b",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { role_abandoned: true, side_conversation: true },
          score_impact: { linguistic_accuracy: 0, role_space_management: 0, equipartial_fidelity: 1, interaction_management: 0, cultural_competence: 1 },
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { spoke_for_maria_again: true, compounding_error: true },
          score_impact: { linguistic_accuracy: 1, role_space_management: 0, equipartial_fidelity: 0, interaction_management: 1, cultural_competence: 1 },
      ...
      options: [
        {
          ...
          is_optimal: true,
          consequences: { recovered_from_error: true, acknowledged_mistake: true },
          score_impact: { linguistic_accuracy: 3, role_space_management: 3, equipartial_fidelity: 3, interaction_management: 3, cultural_competence: 3 },
          next_point: "dp3",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { doubled_down_on_error: true, role_confusion_deepened: true },
          score_impact: { linguistic_accuracy: 1, role_space_management: 0, equipartial_fidelity: 1, interaction_management: 1, cultural_competence: 1 },
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { dishonest_interpretation: true, maria_misrepresented: true },
          score_impact: { linguistic_accuracy: 0, role_space_management: 0, equipartial_fidelity: 0, interaction_management: 1, cultural_competence: 0 },
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { maria_concern_dismissed: true, tension_unaddressed: true },
          score_impact: { linguistic_accuracy: 2, role_space_management: 1, equipartial_fidelity: 1, interaction_management: 1, cultural_competence: 1 },
          next_point: "dp3_damaged",
      ...
      options: [
        {
          ...
          is_optimal: true,
          consequences: { maria_self_advocated: true, interpreter_corrected: true },
          score_impact: { linguistic_accuracy: 4, role_space_management: 3, equipartial_fidelity: 4, interaction_management: 3, cultural_competence: 3 },
          next_point: "dp3",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { maria_silenced_again: true, pattern_of_control: true },
          score_impact: { linguistic_accuracy: 1, role_space_management: 1, equipartial_fidelity: 0, interaction_management: 2, cultural_competence: 1 },
          next_point: "dp3_damaged",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { side_conversation: true, excludes_doctor: true },
          score_impact: { linguistic_accuracy: 1, role_space_management: 1, equipartial_fidelity: 2, interaction_management: 1, cultural_competence: 2 },
          next_point: "dp3_recovery",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { speaking_for_community: true, generalizing: true },
          score_impact: { linguistic_accuracy: 1, role_space_management: 1, equipartial_fidelity: 1, interaction_management: 1, cultural_competence: 1 },
          next_point: "dp3_b",
      ...
      options: [
        {
          ...
          is_optimal: true,
          consequences: { complete_interpretation: true, practical_concerns_voiced: true },
          score_impact: { linguistic_accuracy: 5, role_space_management: 4, equipartial_fidelity: 5, interaction_management: 5, cultural_competence: 4 },
          next_point: "dp4",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { summarized_improperly: true, cost_concern_hidden: true },
          score_impact: { linguistic_accuracy: 1, role_space_management: 2, equipartial_fidelity: 0, interaction_management: 2, cultural_competence: 1 },
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { selective_interpretation: true, cost_barrier_ignored: true },
          score_impact: { linguistic_accuracy: 2, role_space_management: 3, equipartial_fidelity: 0, interaction_management: 2, cultural_competence: 0 },
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { added_commentary: true, role_expansion: true },
          score_impact: { linguistic_accuracy: 3, role_space_management: 1, equipartial_fidelity: 3, interaction_management: 2, cultural_competence: 2 },
          next_point: "dp4",
      ...
      options: [
        {
          ...
          is_optimal: true,
          consequences: { accurate_if_subdued: true },
          score_impact: { linguistic_accuracy: 4, role_space_management: 4, equipartial_fidelity: 4, interaction_management: 3, cultural_competence: 3 },
          next_point: "dp4",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { adding_content: true, compensating_inappropriately: true },
          score_impact: { linguistic_accuracy: 2, role_space_management: 2, equipartial_fidelity: 2, interaction_management: 2, cultural_competence: 2 },
          next_point: "dp4",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { commenting_on_client: true, patronizing: true },
          score_impact: { linguistic_accuracy: 1, role_space_management: 0, equipartial_fidelity: 1, interaction_management: 1, cultural_competence: 1 },
          next_point: "ending_poor",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { good_intent_neutral_outcome: true },
          score_impact: { linguistic_accuracy: 4, role_space_management: 3, equipartial_fidelity: 3, interaction_management: 4, cultural_competence: 3 },
          next_point: "dp4",
      ...
      options: [
        {
          ...
          is_optimal: true,
          consequences: { course_corrected: true, educational_moment: true },
          score_impact: { linguistic_accuracy: 4, role_space_management: 4, equipartial_fidelity: 4, interaction_management: 4, cultural_competence: 3 },
          next_point: "dp4",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { pattern_reinforced: true, maria_further_marginalized: true },
          score_impact: { linguistic_accuracy: 1, role_space_management: 0, equipartial_fidelity: 0, interaction_management: 1, cultural_competence: 0 },
          next_point: "ending_poor",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { dismissive: true, normalizing_exclusion: true },
          score_impact: { linguistic_accuracy: 0, role_space_management: 0, equipartial_fidelity: 0, interaction_management: 0, cultural_competence: 0 },
          next_point: "ending_failed",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { incomplete_recovery: true },
          score_impact: { linguistic_accuracy: 3, role_space_management: 2, equipartial_fidelity: 3, interaction_management: 2, cultural_competence: 2 },
          next_point: "dp4",
      ...
      options: [
        {
          ...
          is_optimal: true,
          consequences: { maria_feelings_voiced: true, vulnerability_shared: true },
          score_impact: { linguistic_accuracy: 5, role_space_management: 4, equipartial_fidelity: 5, interaction_management: 4, cultural_competence: 4 },
          next_point: "dp4",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { emotion_filtered_out: true, trust_concern_missed: true },
          score_impact: { linguistic_accuracy: 1, role_space_management: 2, equipartial_fidelity: 1, interaction_management: 2, cultural_competence: 1 },
          next_point: "dp4_summary",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { dismissed_feelings: true, counselor_role: true },
          score_impact: { linguistic_accuracy: 0, role_space_management: 0, equipartial_fidelity: 0, interaction_management: 1, cultural_competence: 1 },
          next_point: "ending_poor",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { speaking_for_maria: true, not_interpreting_concern: true },
          score_impact: { linguistic_accuracy: 1, role_space_management: 2, equipartial_fidelity: 2, interaction_management: 2, cultural_competence: 2 },
          next_point: "dp4",
      ...
      options: [
        {
          ...
          is_optimal: true,
          consequences: { back_on_track: true, maria_decides: true },
          score_impact: { linguistic_accuracy: 4, role_space_management: 4, equipartial_fidelity: 4, interaction_management: 4, cultural_competence: 3 },
          next_point: "dp4",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { spoke_for_maria: true, pattern_continues: true },
          score_impact: { linguistic_accuracy: 0, role_space_management: 0, equipartial_fidelity: 0, interaction_management: 1, cultural_competence: 1 },
          next_point: "ending_poor",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { more_side_conversation: true, maria_further_excluded: true },
          score_impact: { linguistic_accuracy: 1, role_space_management: 1, equipartial_fidelity: 1, interaction_management: 1, cultural_competence: 1 },
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { adding_content: true, well_intentioned: true },
          score_impact: { linguistic_accuracy: 2, role_space_management: 2, equipartial_fidelity: 2, interaction_management: 3, cultural_competence: 2 },
          next_point: "dp4",
      ...
      options: [
        {
          ...
          is_optimal: true,
          consequences: { accurate_to_situation: true, reflects_damage: true },
          score_impact: { linguistic_accuracy: 4, role_space_management: 4, equipartial_fidelity: 4, interaction_management: 3, cultural_competence: 3 },
          next_point: "ending_mixed",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { misrepresenting_again: true, imposing_assumptions: true },
          score_impact: { linguistic_accuracy: 1, role_space_management: 1, equipartial_fidelity: 0, interaction_management: 1, cultural_competence: 1 },
          next_point: "ending_poor",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { analyzing_client: true, overstepping: true },
          score_impact: { linguistic_accuracy: 0, role_space_management: 0, equipartial_fidelity: 0, interaction_management: 1, cultural_competence: 1 },
          next_point: "ending_poor",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { incomplete_interpretation: true, emotional_state_hidden: true },
          score_impact: { linguistic_accuracy: 2, role_space_management: 2, equipartial_fidelity: 1, interaction_management: 2, cultural_competence: 1 },
          next_point: "ending_mixed",
      ...
      options: [
        {
          ...
          is_optimal: true,
          consequences: { transparency_maintained: true, maria_informed: true },
          score_impact: { linguistic_accuracy: 4, role_space_management: 5, equipartial_fidelity: 5, interaction_management: 5, cultural_competence: 5 },
          next_point: "dp5",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { maria_excluded: true, paternalism_enabled: true },
          score_impact: { linguistic_accuracy: 2, role_space_management: 2, equipartial_fidelity: 0, interaction_management: 1, cultural_competence: 0 },
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { good_intent_awkward_execution: true },
          score_impact: { linguistic_accuracy: 2, role_space_management: 3, equipartial_fidelity: 4, interaction_management: 2, cultural_competence: 3 },
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { passive_approach: true, information_gap: true },
          score_impact: { linguistic_accuracy: 1, role_space_management: 2, equipartial_fidelity: 1, interaction_management: 1, cultural_competence: 1 },
      ...
      options: [
        {
          ...
          is_optimal: true,
          consequences: { maria_recentered: true, specific_needs_voiced: true },
          score_impact: { linguistic_accuracy: 5, role_space_management: 4, equipartial_fidelity: 5, interaction_management: 4, cultural_competence: 4 },
          next_point: "dp5",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { repeated_error: true, maria_filtered_again: true },
          score_impact: { linguistic_accuracy: 1, role_space_management: 2, equipartial_fidelity: 0, interaction_management: 2, cultural_competence: 1 },
          next_point: "ending_poor",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { advocating_instead: true, maria_words_lost: true },
          score_impact: { linguistic_accuracy: 1, role_space_management: 2, equipartial_fidelity: 1, interaction_management: 2, cultural_competence: 2 },
          next_point: "dp5_redirect",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { emotional_context_lost: true, partial_interpretation: true },
          score_impact: { linguistic_accuracy: 3, role_space_management: 3, equipartial_fidelity: 2, interaction_management: 3, cultural_competence: 2 },
          next_point: "dp5",
      ...
      options: [
        {
          ...
          is_optimal: true,
          consequences: { consequence_realized: true, lesson_learned: true },
          score_impact: { linguistic_accuracy: 0, role_space_management: 0, equipartial_fidelity: 0, interaction_management: 0, cultural_competence: 0 },
          next_point: "ending_poor",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { post_hoc_justification: true },
          score_impact: { linguistic_accuracy: 0, role_space_management: 0, equipartial_fidelity: 0, interaction_management: 0, cultural_competence: 0 },
          next_point: "ending_poor",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { scope_creep: true, trying_to_fix: true },
          score_impact: { linguistic_accuracy: 0, role_space_management: 0, equipartial_fidelity: 0, interaction_management: 1, cultural_competence: 1 },
          next_point: "ending_poor",
      ...
      options: [
        {
          ...
          is_optimal: true,
          consequences: { cultural_context_included: true, complete_message: true, maria_trusted_process: true },
          score_impact: { linguistic_accuracy: 5, role_space_management: 5, equipartial_fidelity: 5, interaction_management: 5, cultural_competence: 5 },
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { cultural_context_filtered: true, doctor_missing_info: true },
          score_impact: { linguistic_accuracy: 3, role_space_management: 3, equipartial_fidelity: 1, interaction_management: 3, cultural_competence: 0 },
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { cultural_broker_role: true, maria_expertise_bypassed: true },
          score_impact: { linguistic_accuracy: 2, role_space_management: 1, equipartial_fidelity: 2, interaction_management: 2, cultural_competence: 2 },
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { gatekeeping: true, maria_silenced: true, boundary_violation: true },
          score_impact: { linguistic_accuracy: 0, role_space_management: 0, equipartial_fidelity: 0, interaction_management: 0, cultural_competence: 0 },
          next_point: "ending_failed",
      ...
      options: [
        {
          ...
          is_optimal: true,
          consequences: { health_outcome_affected: true, information_gap_consequence: true },
          score_impact: { linguistic_accuracy: 0, role_space_management: 0, equipartial_fidelity: 0, interaction_management: 0, cultural_competence: 0 },
          next_point: "ending_poor",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { deflecting_responsibility: true },
          score_impact: { linguistic_accuracy: 0, role_space_management: 0, equipartial_fidelity: 0, interaction_management: 0, cultural_competence: 0 },
          next_point: "ending_poor",
      ...
      options: [
        {
          ...
          is_optimal: true,
          consequences: { communication_restored: true, maria_informed: true },
          score_impact: { linguistic_accuracy: 4, role_space_management: 4, equipartial_fidelity: 4, interaction_management: 4, cultural_competence: 4 },
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { appropriate_recovery: true },
          score_impact: { linguistic_accuracy: 4, role_space_management: 4, equipartial_fidelity: 4, interaction_management: 4, cultural_competence: 3 },
          next_point: "ending_good",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { breaking_role: true, minor_issue: true },
          score_impact: { linguistic_accuracy: 3, role_space_management: 2, equipartial_fidelity: 3, interaction_management: 3, cultural_competence: 3 },
          next_point: "ending_good",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { educational_overreach: true },
          score_impact: { linguistic_accuracy: 2, role_space_management: 1, equipartial_fidelity: 2, interaction_management: 2, cultural_competence: 2 },
          next_point: "ending_mixed",
      ...
      options: [
        {
          ...
          is_optimal: true,
          consequences: { late_but_interpreted: true, maria_informed_late: true },
          score_impact: { linguistic_accuracy: 3, role_space_management: 3, equipartial_fidelity: 3, interaction_management: 2, cultural_competence: 3 },
          next_point: "ending_mixed",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { dismissive: true, information_withheld: true },
          score_impact: { linguistic_accuracy: 0, role_space_management: 0, equipartial_fidelity: 0, interaction_management: 1, cultural_competence: 0 },
          next_point: "ending_poor",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { good_recovery_attempt: true, awkward_flow: true },
          score_impact: { linguistic_accuracy: 3, role_space_management: 3, equipartial_fidelity: 4, interaction_management: 2, cultural_competence: 3 },
          next_point: "ending_mixed",
        ...
        },
        {
          ...
          is_optimal: false,
          consequences: { dishonest: true, avoidance: true },
          score_impact: { linguistic_accuracy: 0, role_space_management: 0, equipartial_fidelity: 0, interaction_management: 0, cultural_competence: 0 },
          next_point: "ending_poor",
...
async function updateScenarioData() {
  console.log("Updating scenario drill data with full branching structure...");

  const { data, error } = await supabase
    .from("scenario_drills")
    .update({
      scenario_data: fullScenarioData,
      updated_at: new Date().toISOString()
    })
    .eq("slug", "the-diagnosis")
  ...
  if (data && data.length > 0) {
    console.log("✅ Successfully updated scenario:", data[0].title);
    console.log(`   Decision points: ${fullScenarioData.decision_points.length}`);
    console.log(`   Endings: ${Object.keys(fullScenarioData.endings).length}`);
  } else {
    console.log("⚠️ No scenario found with slug 'the-diagnosis'. You may need to run the migration first.");
  }
}
