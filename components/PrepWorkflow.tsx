        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[1fr_340px]">
                    ...
                    <div className={`rounded-xl border ${colors.border} ${colors.bg} px-4 py-3`}>
                      <div className="flex flex-wrap items-center justify-between gap-2">
                        <div className="flex items-center gap-3">
                          ...
                          <span className={`inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[0.65rem] font-medium ${colors.bg} ${colors.text}`}>
                            {step.tag}
                          </span>
                        </div>
                        <span className="text-[0.65rem] text-slate-500">{step.duration}</span>
                      </div>
                      <p className="mt-2 text-sm font-medium text-slate-100">{step.action}</p>
            ...
            <div className="mt-6 pl-12">
              <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/10 px-4 py-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-emerald-300">Total: 30 minutes</span>
                </div>
          ...
          <div className="space-y-4">
            <div className="rounded-2xl border border-slate-800 bg-slate-900/80 p-5">
              <p className="text-[0.7rem] uppercase tracking-wide text-slate-400">Example: PhD Interview</p>
              <div className="mt-3 space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-200">Sign Language Technology Lab</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-200">Dr. Sarah Ebling</p>
                    <p className="text-[0.7rem] text-slate-400">Accessibility researcher, Zurich</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-200">Brienna Herold</p>
                    <p className="text-[0.7rem] text-slate-400">ASL linguist, tech focus</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="mt-1 h-1.5 w-1.5 rounded-full bg-emerald-400 flex-shrink-0" />
                  <div>
                    <p className="text-xs text-slate-400">Team interpreter</p>
                    <p className="text-sm text-slate-200">Janina</p>
                    <p className="text-[0.7rem] text-slate-400">Preconference scheduled</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/80 p-5">
              <p className="text-[0.7rem] uppercase tracking-wide text-slate-400">What the OS helped you understand</p>
              <div className="mt-3 space-y-2 text-xs text-slate-300">
                <p>• The sign language technology pipeline</p>
                <p>• Dr. Ebling's philosophy on Deaf-led research</p>
                <p>• Brienna's career trajectory and publications</p>
                <p>• Likely topics: corpus linguistics, avatar ethics</p>
                <p>• Power dynamics in academic interviews</p>
              </div>
            </div>

            <div className="rounded-2xl border border-violet-500/30 bg-violet-500/10 p-5">
              <p className="text-[0.7rem] uppercase tracking-wide text-violet-300">After the assignment</p>
