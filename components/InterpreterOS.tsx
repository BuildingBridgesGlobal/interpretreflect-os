    ...
    <section id="interpreter-os" className="border-t border-slate-900/80 bg-gradient-to-b from-slate-950 via-slate-900/20 to-slate-950">
      <div className="container mx-auto max-w-6xl px-6 md:px-8 py-16 md:py-20">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h2 className="mt-3 text-3xl md:text-4xl font-semibold text-slate-50 tracking-tight">{title}</h2>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <p className={`text-xs uppercase tracking-wide ${colors.text}`}>{phase.phase}</p>
                    <p className="text-sm font-medium text-slate-100">{phase.label}</p>
                  </div>
                </div>
        ...
        <div className="mt-12 rounded-2xl border border-slate-800 bg-slate-900/60 p-6 md:p-8">
          <div className="grid gap-8 md:grid-cols-2 items-center">
            <div>
              <p className="text-[0.75rem] font-medium uppercase tracking-[0.16em] text-slate-400">Think of it like this</p>
              <h3 className="mt-2 text-xl md:text-2xl font-semibold text-slate-50">
            ...
            <div className="space-y-3">
              <div className="rounded-xl bg-slate-950/60 border border-slate-800/50 p-4">
                <p className="text-xs text-slate-400 uppercase tracking-wide">Without an OS</p>
              ...
              <div className="rounded-xl bg-teal-500/10 border border-teal-500/30 p-4">
                <p className="text-xs text-teal-300 uppercase tracking-wide">With InterpretReflect</p>
