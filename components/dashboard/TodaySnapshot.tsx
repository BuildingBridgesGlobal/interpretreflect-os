...
export default function TodaySnapshot({ data }: { data: Data | null }) {
  ...
  return (
    <section className="rounded-2xl border border-slate-800 bg-slate-900/80 p-6">
      ...
      <p className="mt-2 text-sm text-slate-300">{heavy ? "Your last week has been heavy. Let’s keep this OS gentle and doable." : "Your load is currently in the manageable range. We’ll watch for drift and subtle shifts."}</p>
